...
ActiveRecord::Schema.define(version: 2019_09_11_190321) do
  ...
  create_table "keppler_products_catalogues", force: :cascade do |t|
    t.string "banner"
    t.integer "position"
    t.datetime "deleted_at"
    t.datetime "created_at"
  ...
  create_table "keppler_products_cotizations", force: :cascade do |t|
    t.string "name"
    t.string "email"
    t.string "phone"
    t.text "message"
  ...
  create_table "keppler_products_designs", force: :cascade do |t|
    t.string "url"
    t.integer "position"
    t.datetime "deleted_at"
    t.datetime "created_at"
